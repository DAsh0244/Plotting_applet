...
class ConfigData:
    ...
    def __init__(self):
        ...
        self.writeNum = 0
        self.bit_layout = [1, 0, 0]  # (BitDepthIndex <int>, MSB / LSBIndex <int>, VoltageIndex <int>)
    ...
    def set_bit_data(self, data):
        ...
        # module_logger.info('{} {} {} {}'.format(self.BitDepth, self.BitOrder, self.MinVoltage, self.MaxVoltage))
